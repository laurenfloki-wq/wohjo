// Paired-guard test (CP-1 slice 2b, 2026-06-10) — approve
//
...
const SRC = readFileSync(
  join(process.cwd(), 'src/app/api/command/shifts/[shiftId]/approve/route.ts'),
  'utf-8',
);

describe('approve — seam paired-guard', () => {
