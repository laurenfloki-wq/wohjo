...
export default function FieldLoginPage() {
  ...
  return (
    <div style={{
      ...
      {/* Legal footer */}
      <p style={{ fontSize: '11px', color: 'rgba(255,255,255,0.4)', textAlign: 'center', marginTop: '24px', lineHeight: 1.5 }}>
        By signing in you agree to our{' '}
        <a href="/terms" style={{ color: 'rgba(255,255,255,0.6)', textDecoration: 'underline' }}>Terms of Service</a>
        {' '}and{' '}
      ...
      <p style={{ fontSize: '11px', color: 'rgba(255,255,255,0.35)', textAlign: 'center', marginTop: '8px', lineHeight: 1.5, maxWidth: '380px' }}>
