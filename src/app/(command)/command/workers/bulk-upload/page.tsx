            ...
            <tbody>
              {rows.slice(0, 50).map((r) => (
                <tr key={r.row_index} style={{ borderBottom: '1px solid var(--rule)' }}>
                  <td style={{ padding: '10px 12px', color: 'var(--ink-muted)' }}>{r.row_index}</td>
                  <td style={{ padding: '10px 12px', color: 'var(--ink)' }}>{r.employee_id}</td>
                  <td style={{ padding: '10px 12px', color: 'var(--ink)' }}>
                    {r.first_name} {r.last_name === '-' ? '' : r.last_name}
                  </td>
                  <td style={{ padding: '10px 12px', color: 'var(--ink-secondary)' }}>{r.phone}</td>
