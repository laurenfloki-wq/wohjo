...
// Flostruction Export — MYOB Formatter (Stub)
// TODO: Implement MYOB timesheet import format
// Reference: https://developer.myob.com/api/accountright/v2/payroll/timesheet/
...
export const MYOBFormatter: ExportFormatter = {
  providerId: 'myob',
  providerName: 'MYOB',
  fileExtension: 'csv',
  mimeType: 'text/csv',
  ...
  validate(_shifts: ApprovedShift[]): ValidationError[] {
    // TODO: Implement MYOB-specific validation
    throw new Error('MYOBFormatter not yet implemented — Phase 2');
  },

  format(_shifts: ApprovedShift[]): string {
    // TODO: Implement MYOB timesheet CSV format
    throw new Error('MYOBFormatter not yet implemented — Phase 2');
  },
};
