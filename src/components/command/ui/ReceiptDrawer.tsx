    ...
    >
      <aside
        ...
        style={{
          ...
          backgroundImage:
            'linear-gradient(180deg, var(--surface) 0%, var(--surface) 70%, var(--surface-sunken) 100%)',
        }}
      >
        <header
          style={{
        ...
        <div style={{ padding: 'var(--s-5) var(--s-5) var(--s-6)', overflowY: 'auto', flex: 1 }}>
          ...
          {loading ? (
            <div style={{ color: 'var(--ink-muted)', padding: 'var(--s-5) 0' }}>
              Assembling timeline…
            </div>
          ) : error ? (
            <div
              ...
              {(entries ?? []).map((e, i) => (
                <li
                  ...
                  style={{
                    ...
                    borderBottom:
                      i === (entries?.length ?? 0) - 1 ? 'none' : '1px solid var(--border)',
                    boxShadow:
                      i === (entries?.length ?? 0) - 1 ? 'none' : '0 1px 0 0 var(--border-emboss)',
                ...
                >
                  <div style={{ paddingRight: 12 }}>
                    ...
                    <div
                      style={{ color: 'var(--ink-muted)', fontSize: 'var(--t-xs)', marginTop: 2 }}
                    >
