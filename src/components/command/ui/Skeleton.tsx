...
export function Skeleton({
  width = '100%', height = 14, radius = 6, style, lines,
}: Props) {
  if (lines && lines > 1) {
    return (
...
export function SkeletonRow({ columns = 4 }: { columns?: number }) {
  return (
    <div style={{ display: 'grid', gridTemplateColumns: `repeat(${columns}, 1fr)`, gap: 16, padding: '14px 16px', borderBottom: '1px solid var(--border)' }}>
