...
export function SiteMap({ lat, lng, radiusMetres, size = 96 }: Props) {
  ...
  return (
    ...
    >
      {/* Inner plate */}
      <rect x={inset} y={inset} width={plot} height={plot} fill="var(--surface)" stroke="var(--border)" strokeWidth={0.6} />
      ...
      <g transform={`translate(${inset + 2}, ${inset + 2})`}>
        ...
        <text
          ...
          y={20}
          textAnchor="middle"
          style={{ fontFamily: 'var(--font-mono)', fontSize: 7, fill: 'var(--ink-secondary)', letterSpacing: '0.1em' }}
        >
          N
        </text>
      </g>
      ...
      <g transform={`translate(${inset + plot - 36}, ${inset + plot - 14})`}>
        ...
        <text
          ...
          y={2}
          textAnchor="middle"
          style={{ fontFamily: 'var(--font-mono)', fontSize: 7, fill: 'var(--ink-secondary)', letterSpacing: '0.06em' }}
        >
          1 km
        </text>
      </g>
