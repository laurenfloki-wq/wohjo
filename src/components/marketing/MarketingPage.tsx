    ...
    <div className={`mkt ${marketingFontClasses}`}>
      ...
      <header className="mkt-header">
        <nav className="nav">
          ...
          <div className="right">
            <button className="btn-link" type="button" onClick={() => setModalOpen(true)}>Talk to us</button>
            <button className="btn btn-solid" type="button" onClick={() => setModalOpen(true)}>Book a demo</button>
          </div>
        </nav>
      </header>
      ...
      <section className="band">
        <RevealSection className="problem wrap">
          ...
          <p className="reveal d3">
            Paper timesheets, approvals that vanish into WhatsApp, disputes argued line by line every pay run. Flostruction&apos;s answer is simple: evidence when you need it.
          </p>
        </RevealSection>
      </section>
      ...
      <RevealSection as="section" className="closing">
        <div className="wrap">
          <h2 className="reveal d1">
            Every hour verified.<br />
            <span style={{ color: 'var(--gold)' }}>Every record permanent.</span>
          </h2>
          <p className="reveal d2">
            Records written to the Workforce Ledger Evidentiary Standard (WLES). Worker-confirmed on site, supervisor-verified by SMS, permanent and exportable.
          </p>
          <div className="cta reveal d3">
            <button className="btn btn-solid" type="button" onClick={() => setModalOpen(true)}>Book a demo</button>
            <a className="btn btn-ghost" href="/wles">Read the WLES standard</a>
          </div>
        </div>
      </RevealSection>
      </main>
      ...
      <footer className="mkt-footer">
        <div className="wrap">
          <div className="row">
            <span>© 2026 FLOSMOSIS PTY LTD (ACN 697 323 925) · Flostruction is a product of FLOSMOSIS PTY LTD · Built in Australia.</span>
            <span><a href="/privacy">Privacy Policy</a> · <a href="/terms">Terms of Service</a></span>
          </div>
        </div>
        <div className="disc">
          Flostruction is a workforce time verification platform. It does not calculate wages, award entitlements, tax, or superannuation. Demo records show synthetic data; names, sites, and hashes are illustrative.
        </div>
      </footer>
