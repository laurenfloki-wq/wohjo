...
export const PhoneFrame: FC<{ children: React.ReactNode; height?: number }> = ({
  ...
  <div
    style={{
      ...
      height,
      margin: '0 auto',
      // Subtle vertical bezel gradient so the frame catches light like a
      // physical device instead of reading as one flat charcoal block.
      background: 'linear-gradient(155deg, #2A2A2E 0%, #1A1A1C 55%, #121214 100%)',
      borderRadius: 42,
      padding: 11,
      // Layered, charcoal-tinted elevation (ambient + key) with a thin
      // bezel ring and a soft top highlight — depth without glow.
      boxShadow:
      ...
      >
        ...
        <div
          style={{
            ...
            textAlign: 'center',
            boxShadow: '0 1px 2px rgba(15,15,16,0.06), 0 6px 18px -10px rgba(15,15,16,0.14)',
            maskImage:
