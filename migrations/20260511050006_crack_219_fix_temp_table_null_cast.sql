-- CRACK 219 hotfix: cast bare NULLs to typed NULLs in _export_chain_heads seed
-- Postgres error: "column last_event_id is of type uuid but expression is of type text"
-- Untyped NULL defaults to text; explicit ::uuid and ::text casts make planner happy.
-- All else identical to crack_219_create_export_rpc.
...
BEGIN
  ...
  -- HOTFIX: explicit type casts on NULLs (was bare NULL, defaulted to text)
  INSERT INTO _export_chain_heads (worker_id, last_event_id, last_event_hash)
